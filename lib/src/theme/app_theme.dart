...
const Color primaryOrange = Color.fromARGB(
  255,
  247,
  128,
  92,
...
const Color charcoal = Color(
  0xFF2D2D2D,
); // Strong for text, contrast, and modern feel

// Secondary Colors
const Color limeGreen = Color(
  0xFF32CD32,
); // Motivation, success (e.g. goal complete, streaks)
const Color warmRedCoral = Color(
  0xFFFF6347,
); // Reminders, missed check-ins, gentle nudges
...
final ThemeData appThemeData = ThemeData(
  ...
  colorScheme: const ColorScheme(
    ...
    secondary:
        limeGreen, // Can be used for floating action buttons, active states etc.
